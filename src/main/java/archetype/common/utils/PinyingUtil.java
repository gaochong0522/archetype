...
public class PinyingUtil {
    ...
    public static String getHead(String src){
        StringBuffer sb = new StringBuffer("");
        String [] str = getHeadByString( src, true);
        if (str != null) {
            for (int i = 0; i < str.length; i++) {
                sb.append(str[i]);
            }
    ...
    public static String getHead(String src, boolean isCapital){
        String [] str = getHeadByString( src, isCapital);
        StringBuffer sb = new StringBuffer("");
        if (str != null) {
            for (int i = 0; i < str.length; i++) {
                sb.append(str[i]);
	...
	public static void main(String[] args) {
		...
		System.out.println(getHeadByString("是否大写")[0]);
		System.out.println(getHeadByString("是否大写")[1]);
		System.out.println(getFirstSpell("是否大写"));
	}
}
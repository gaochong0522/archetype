...
public class StuUserController extends BaseController {
	...
	public String list(Model model) {
		...
		return this.result(ResultType.FTL, "/stuUser/stuUser_list");
	}
	...
	public String doAdd(Model model, @ModelAttribute("stuUser") StuUser stuUser) {
		...
		return this.result(ResultType.FTL, "/stuUser/stuUser_form");
	}
	...
	public String detail(Model model,@PathVariable("id") long id) {
		...
		return this.result(ResultType.FTL, "/stuUser/stuUser_detail");
	}
